...
export default class RepPhoneCreator extends Component {
    constructor(props) {
        super(props);
        ...
        return (
            <form onSubmit={this.handleFormSubmit}>
                ...
                <div className={`form-group ${quantityInputError ? 'has-error' : ''}`}>
                    ...
                    {quantityInputError && <span className="form-control is-invalid">{quantityInputError}</span>}
                </div>
                {' '}
